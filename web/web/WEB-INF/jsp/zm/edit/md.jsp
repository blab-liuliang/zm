...
<body>
    <form:form method="post" action="/zm/modify_md" modelAttribute="markdown">
        ...
        <form:input path="courseName" hidden="true"></form:input>
        <form:input path="unitName" hidden="true"></form:input>
        <form:input path="lessonName" hidden="true"></form:input>
        <form:input path="markdownName" hidden="true"></form:input>
